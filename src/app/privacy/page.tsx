...
export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12 leading-relaxed">
      ...
      <p className="text-sm text-slate-500 mb-10">最終更新日: 2026年7月27日</p>
      ...
      <Section title="1. 取得する情報">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>撮影した写真</strong>: 顔・手・上半身・靴などの写真を、AIによる身だしなみ診断のためだけに使用します。写真はお使いの端末上で一時的に処理され、診断のために後述のOpenAI社のサービスへ送信されます。開発者が管理するサーバーやデータベースに写真を保存・蓄積することはありません。
          </li>
          <li>
